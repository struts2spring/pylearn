...
class ScrolledThumbnail(wx.ScrolledWindow):
    ...
    def ShowDir(self, books, filter=THUMB_FILTER_IMAGES):
        """
...
#         filenames=['advanced_rails_recipes.jpg']

#         for files in filenames:
# 
#             caption = (self._showfilenames and [files] or [""])[0]
#             fullfile = opj(self._dir + "/" + files)
#             fullfile='/home/vijay/Documents/Aptana_Workspace/Better/seleniumone/books/2/advanced_rails_recipes.jpg'
#             
...
#         file2='advanced_rails_recipes.jpg'
#         file3='agile_web_development_with_rails_3rd_edition.jpg'
#         folder2='/home/vijay/Documents/Aptana_Workspace/Better/seleniumone/books/2'
...
#                 thumbs.append(Thumb(self, folder, files, caption, size, lastmod))
#                 pass
            thumbs.append(Thumb(self, imagePath, imageName, bookName, size, lastmod))
